...
- Host-only actions need session host in-world.
- After updates, fully restart BL4.
- GZO catalog: [save-editor.be](https://save-editor.be/GZO/Borderlands4/Codes.html). Thanks **Tobgun** for testing and feedback.
